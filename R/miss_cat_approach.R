...
miss_cat_approach = function(outcome, covar = NULL, zeros = NULL, ali, data, family, use_glm = TRUE, rf_mtry = NULL, rf_min_node_size = NULL, rf_splitrule = "gini", rf_num_trees = 500) {
