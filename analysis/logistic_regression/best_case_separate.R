...
# Logistic regression + best-case imputation (separate)
...
saveRDS(object = out, 
        file = "~/Documents/missALI/analysis/fitted_models/logistic_regression/full_best_case_separate.rds")
...
saveRDS(object = out_kfold, 
        file = "~/Documents/missALI/analysis/fitted_models/logistic_regression/kfold_best_case_separate.rds")