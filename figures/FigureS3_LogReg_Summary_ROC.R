...
full_cc_prop = readRDS("~/Documents/missALI/analysis/fitted_models/logistic_regression/full_complete_case_proportion.rds")
kfold_cc_prop = readRDS("~/Documents/missALI/analysis/fitted_models/logistic_regression/kfold_complete_case_proportion.rds")
## Counts of missing and unhealthy
full_num_miss = readRDS("~/Documents/missALI/analysis/fitted_models/logistic_regression/full_counts_missing_unhealthy.rds")
kfold_num_miss = readRDS("~/Documents/missALI/analysis/fitted_models/logistic_regression/kfold_counts_missing_unhealthy.rds")
## Best-case imputation (summary)
full_best = readRDS("~/Documents/missALI/analysis/fitted_models/logistic_regression/full_best_case_summary.rds")
kfold_best = readRDS("~/Documents/missALI/analysis/fitted_models/logistic_regression/kfold_best_case_summary.rds")
